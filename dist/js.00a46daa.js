...
exports.getSiblings = exports.getMousePos = exports.lerp = void 0;
...
var Cursor = /*#__PURE__*/function () {
  function Cursor(el) {
    ...
    this.bounds = this.Cursor.getBoundingClientRect(); // Amt Nastavení Cursor follow dot delay
  ...
  _createClass(Cursor, [{
    ...
    value: function scaleAnimation(el, amt) {
      ...
      _gsap.gsap.to(this.Cursor.children[0], {
        duration: 0.6,
        scale: amt,
        ease: "Power3.easeOut"
      });
    ...
    value: function render() {
      ...
      this.cursorConfigs.y.current = mouse.y; // lerp Lineární interpolace 
      ...
      this.Cursor.style.transform = "translateX(".concat(this.cursorConfigs.x.previous, "px) translateY(").concat(this.cursorConfigs.y.previous, "px)"); //RAF requestAnimationFrame
